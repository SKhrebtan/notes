...
export const Words = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const enWord =
      englishWord || (formElements.namedItem('eng') as HTMLInputElement)?.value;
    const uaWord = (formElements.namedItem('uak') as HTMLInputElement)?.value;
  ...
  const handleDefinitionSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const {
      ...
      `https://api.mymemory.translated.net/get?q=${word}&langpair=en|uk`
    );
            ...
            return (
              <li key={translation}>
                ...
                <button
                  ...
                  type="button"
                  onClick={() => handleWordPick(translation)}
                >
                  Choose
                </button>
              </li>
